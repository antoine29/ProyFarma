                ...
                ?>
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="<?php echo Farmacia::baseurl() ?>app/editFarmacia.php?farmacia=<?php echo $farmacia->idfarmacia ?>">Editar </a> 
                                    <a class="btn btn-info" href="<?php echo Farmacia::baseurl() ?>app/deleteFarmacia.php?farmacia=<?php echo $farmacia->idfarmacia ?>">Eliminar </a>
                                </td>
                            </tr>
                            <?php
                            }
